  ...
  return (
    <div>
      ...
      <MyButton
        size='smallWithIcon'
        variant='contained'
        endIcon={<PlaylistAddCheckRoundedIcon sx={{ fontSize: '16px' }} />}
      >
        Call to Action
      </MyButton>
      <MyButton
        size='smallWithIcon'
        variant='outlined'
        startIcon={<ExitToAppRoundedIcon sx={{ fontSize: '16px' }} />}
      >
        Call to Action
      </MyButton>
      ...
      <MyButton size='medium' variant='contained'>
        Call to Action
      </MyButton>
      <MyButton
        size='mediumWithIcon'
